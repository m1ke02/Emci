...
gcc -Wall -g -O3 -c src/cmd_arg.c          -I include -I . -o obj/cmd_arg.o
gcc -Wall -g -O3 -c src/cmd_parser.c       -I include -I . -o obj/cmd_parser.o
gcc -Wall -g -O3 -c src/cmd_std_handlers.c -I include -I . -o obj/cmd_std_handlers.o
